defmodule TemporahWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: TemporahWeb.Layouts]

      use Gettext, backend: TemporahWeb.Gettext
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {TemporahWeb.Layouts, :app}
  ...
  defp html_helpers do
    quote do
      ...
      import Phoenix.HTML
      # Core UI components
      import TemporahWeb.CoreComponents
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: TemporahWeb.Router,
        statics: TemporahWeb.static_paths()
    end
  end
