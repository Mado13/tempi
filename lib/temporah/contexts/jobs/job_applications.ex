defmodule Temporah.Contexts.Jobs.JobApplications do
  alias Ecto.Multi
  alias Temporah.Repo
  alias Temporah.Schemas.Jobs.JobApplication
  import Temporah.Contexts.Jobs.JobAgreement, only: [create_job_agreement: 1]
